...
$.loadding = {
    show: function (msg) {
        $("<div class=\"datagrid-loadding\" style=\"position:absolute;left:0;width:100%;height:" + $(document).height() + "px;top:0;background:#E0ECFF;opacity:0.8;filter:alpha(opacity=80);\">").appendTo("body");
        $("<div class=\"datagrid-mask-msg\">" + msg + "</div>").appendTo("body").css({ display: "block", left: ($(document.body).outerWidth(true) - 190) / 2, top: ($(window).height() - 45) / 2 });
    },
    close: function () {
        $(".datagrid-loadding").remove();
